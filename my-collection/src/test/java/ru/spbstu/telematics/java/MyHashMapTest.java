...
// Intentionally non-comparable
    ...
    MyMap<String, String> newTable() {
        return new MyHashMap<>();
    }

    MyMap<Key, String> newStrangeKeyTable() {
        return new MyHashMap<>();
    }

    MyMap<AntiKey, String> newAntiKeyTable() {
        return new MyHashMap<>();
    }

    @Test
    void emptyTable() {
        MyMap<String, String> table = newTable();
    ...
    void notComparableKey() {
        MyMap<Key, String> table = newStrangeKeyTable();
    ...
    void removeWithCollision() {
        MyMap<AntiKey, String> table = newAntiKeyTable();
